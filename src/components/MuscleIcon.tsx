...
function fill(group: MuscleGroup, muscle: MuscleGroup, hl: string): string {
  ...
  return (
    ...
    >
      <Svg width={w} height={h} viewBox="0 0 100 120">
        {side === 'front' ? (
          <FrontBody muscle={muscle} hl={hl} />
        ) : (
          <BackBody muscle={muscle} hl={hl} />
        )}
      </Svg>
    </View>
  );
...
function FrontBody({ muscle, hl }: { muscle: MuscleGroup; hl: string }) {
  return (
    <G>
      ...
      />
      <Ellipse cx="30" cy="38" rx="7" ry="6" fill={fill('Shoulders', muscle, hl)} />
      <Ellipse cx="70" cy="38" rx="7" ry="6" fill={fill('Shoulders', muscle, hl)} />
      <Path
        d="M40 34 Q50 32 60 34 L62 46 Q50 49 38 46 Z"
        fill={fill('Chest', muscle, hl)}
      />
      <Path
        d="M24 42 L28 56 L24 68 L20 56 Z"
        fill={fill('Biceps', muscle, hl)}
      />
      <Path
      ...
      <Path
        ...
        fill={fill('Abs', muscle, hl)}
      />
      <Path
        d="M34 76 L46 76 L46 102 L38 104 Z"
        fill={fill('Quads', muscle, hl)}
      />
      <Path
...
function BackBody({ muscle, hl }: { muscle: MuscleGroup; hl: string }) {
  return (
    <G>
      <Circle cx="50" cy="15" r="10" fill={BASE_SOFT} stroke={OUTLINE} strokeWidth="0.8" />
      <Path
      ...
      <Path
        ...
        fill={fill('Traps', muscle, hl)}
      />
      <Path
        d="M36 40 Q50 42 64 40 L66 62 Q50 66 34 62 Z"
        fill={fill('Lats', muscle, hl)}
      />
      <Path
        d="M44 64 L56 64 L55 72 L45 72 Z"
        fill={fill('Lower Back', muscle, hl)}
      />
      <Path
        d="M24 42 L28 56 L24 68 L20 56 Z"
        fill={fill('Triceps', muscle, hl)}
      />
      <Path
        d="M76 42 L80 56 L76 68 L72 56 Z"
        fill={fill('Triceps', muscle, hl)}
      ...
      <Path
        ...
        fill={fill('Glutes', muscle, hl)}
      />
      <Path
        d="M36 86 L46 86 L44 104 L38 106 Z"
        fill={fill('Hamstrings', muscle, hl)}
      />
      <Path
